Gem::Specification.new do |spec|
  ...
  spec.version       = '1.1.0'
  spec.authors       = ['Cristian Bica', 'Luiz Carvalho']
  spec.email         = ['cristian.bica@gmail.com', 'contato@luizcarvalho.com']
  spec.description   = 'A lita extension to build wizards'
  spec.summary       = 'A lita extension to build wizards (surveys, standups, etc)'
  spec.homepage      = 'https://github.com/luizcarvalho/lita-wizard'
  spec.license       = 'MIT'
